...
const About = () => {
    return (
        <div id='about' className='rounded'>
            ...
            <p>Autodidacte dans l’âme, j’aime apprendre et découvrir. En 2021, j'ai décidé d'intégrer la formation Web Design du GRETA Auvergne. Cette formation me permet aujourd'hui d'étudier et d’approfondir tout le cheminement que nécessite la création d'un site web (brainstorming, moodboard, maquette, code, etc.). Grâce à cette formation, j'ai pu valider le <b>Titre Pro Design Web</b></p>
            <p>
                Pour compléter mon parcours d'apprentissage, j'ai intégré la formation <b>Développeur Fullstack JS</b> de l'école en ligne <b>O'Clock</b>.
            </p>
        </div>
    );
};
